...
<div class="main-content" style="max-width: 700px;">
    <h1 class="page-title">📝 Регистрация в автосервисе</h1>
...
<?php if(isset($_GET['error'])): ?>
    <div class="alert alert-error" style="margin-bottom: 20px;">
        ...
        $errors = [
            ...
            'phone_too_long' => '❌ Номер телефона слишком длинный (макс. 18 символов)!', // ИЗМЕНЕНО!
...
function validatePhone() {
    ...
    if (phone.length > 18) {  // ИЗМЕНЕНО: было 13, стало 18
        phoneInput.style.borderColor = '#c62828';
        return false;
    }
...
document.querySelector('form').addEventListener('submit', function(e) {
    // ... существующие проверки паролей ...
    
    if (!validatePhone()) {
        e.preventDefault();
        alert('Пожалуйста, введите корректный номер телефона (минимум 10 цифр, максимум 18 символов)'); // ИЗМЕНЕНО!
        phoneInput.focus();
        return false;
    }
